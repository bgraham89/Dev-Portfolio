...
import { faEnvelope, faHome, faUser, faBriefcase, faPersonChalkboard } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <div className='nav-bar'>
            ...
            <nav id='internal-links'>
                ...
                <NavLink exact='true' activeclassname='active' className='assets-link' to='/assets'>
