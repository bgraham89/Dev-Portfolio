const Mathematics = () => {
    return (
        <div className='box flex-col'>
            <h2>Resources for School+:</h2>
            <ul>
                <li><a href="https://www.cognitoresources.org/resources/gcse/videos/maths" target="_blank">GCSE Mathematics Videos - Cognito</a></li>
                <li><a href="https://www.cognitoresources.org/home" target="_blank">GCSE Mathematics Past Papers - Cognito</a></li>
                <li><a href="https://www.cognitoresources.org/home" target="_blank">A-Level Mathematics Past Papers - Cognito</a></li>
            </ul>
            <h2>Resources for University+</h2>
            <ul>
                <li><a href="https://www.youtube.com/playlist?list=PLVMgvCDIRy1wONAFFjMV9c0QaNuyfT5Gk" target="_blank">Abstract Linear Algebra Videos - MathMajor</a></li>
                <li><a href="https://www.youtube.com/playlist?list=PLVMgvCDIRy1wzJcFNGw7t4tehgzhFtBpm" target="_blank">Complex Analysis Videos - MathMajor</a></li>
            ...
            <h2>Resources for Competitions</h2>
            <ul>
                <li><a href="https://kskedlaya.org/putnam-archive/" target="_blank">Putnam Past Papers - Kiran Kedlaya</a></li>
